...
#s3://bnx-e2e-test/data/input_file.csv
...
#aws s3 cp $PATHBNX/test_spark_output.py s3://$BUCKET/scripts/glue_job.py
aws s3 cp $PATHBNX/test_new.py s3://$BUCKET/scripts/glue_job.py
