...
// ── Data ────────────────────────────────────────────────────
const EFFORT_DATA = [
  // ── Mes 1: Core Engine (Sesiones 1-6) ──
  { phase: 'Parser MP/XFR/DML', traditional: 40, bnx: 3, unit: 'hrs', month: 1 },
  { phase: 'DAG Builder + Topo Sort', traditional: 24, bnx: 2, unit: 'hrs', month: 1 },
  { phase: 'Semantic Validator + Accuracy', traditional: 32, bnx: 2, unit: 'hrs', month: 1 },
  { phase: 'Glue Codegen (GlueContext + DynamicFrame)', traditional: 40, bnx: 3, unit: 'hrs', month: 1 },
  { phase: 'PySpark Codegen (SparkSession)', traditional: 32, bnx: 2, unit: 'hrs', month: 1 },
  { phase: 'COBOL Parser + EBCDIC/COMP-3', traditional: 60, bnx: 3, unit: 'hrs', month: 1 },
  { phase: 'DEDUP/NORMALIZE/LOOKUP/GATHER', traditional: 24, bnx: 2, unit: 'hrs', month: 1 },
  { phase: 'React UI + DAG Viewer interactivo', traditional: 48, bnx: 4, unit: 'hrs', month: 1 },
  { phase: 'Designer Visual (drag & drop)', traditional: 60, bnx: 4, unit: 'hrs', month: 1 },
  // ── Mes 2: Multi-target + Orquestación (Sesiones 7-11) ──
  { phase: 'Source/Sink Connectors (S3/JDBC/Kafka)', traditional: 32, bnx: 3, unit: 'hrs', month: 2 },
  { phase: 'Apache Flink Codegen (PyFlink + SQL)', traditional: 48, bnx: 3, unit: 'hrs', month: 2 },
  { phase: 'Grafo de Grafos (PLAN + multi-MP + cross-edges)', traditional: 48, bnx: 3, unit: 'hrs', month: 2 },
  { phase: 'Planes Cíclicos (CYCLIC + convergence)', traditional: 36, bnx: 3, unit: 'hrs', month: 2 },
  { phase: 'Step Functions + Terraform Codegen', traditional: 32, bnx: 2, unit: 'hrs', month: 2 },
  { phase: 'Airflow DAG Codegen', traditional: 24, bnx: 2, unit: 'hrs', month: 2 },
  { phase: 'E2E Test AWS Glue + IAM policies', traditional: 20, bnx: 2, unit: 'hrs', month: 2 },
  { phase: 'Deploy (Amplify + Lambda + CI/CD)', traditional: 16, bnx: 2, unit: 'hrs', month: 2 },
  // ── Mes 3: Enterprise + Governance + Optimización (Sesiones 12-16) ──
  { phase: 'Refactorizador Spark 2→3 / Python 2→3 / Glue 2→4', traditional: 40, bnx: 3, unit: 'hrs', month: 3 },
  { phase: 'Executive Dashboard + Banking Model', traditional: 40, bnx: 3, unit: 'hrs', month: 3 },
  { phase: 'DAMA Framework (8 dominios)', traditional: 28, bnx: 2, unit: 'hrs', month: 3 },
  { phase: 'Governance (55+ políticas + madurez)', traditional: 36, bnx: 3, unit: 'hrs', month: 3 },
  { phase: 'Architecture + Glosario de mecanismos', traditional: 32, bnx: 3, unit: 'hrs', month: 3 },
  { phase: 'Metrics + Estimadores + Comparativa 3-way', traditional: 28, bnx: 3, unit: 'hrs', month: 3 },
  { phase: 'OCR + ZIP packaging + Admin mode', traditional: 24, bnx: 2, unit: 'hrs', month: 3 },
  { phase: 'API (FastAPI + Lambda + endpoints)', traditional: 24, bnx: 2, unit: 'hrs', month: 3 },
]
