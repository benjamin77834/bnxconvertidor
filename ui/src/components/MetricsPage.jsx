...
const EFFORT_DATA = [
  ...
  { phase: 'PySpark Codegen', traditional: 32, bnx: 2, unit: 'hrs' },
  { phase: 'Apache Flink Codegen (PyFlink + SQL)', traditional: 48, bnx: 3, unit: 'hrs' },
  { phase: 'COBOL Parser + EBCDIC/COMP-3', traditional: 60, bnx: 3, unit: 'hrs' },
  { phase: 'DEDUP/NORMALIZE/LOOKUP/GATHER', traditional: 24, bnx: 2, unit: 'hrs' },
  { phase: 'Accuracy Engine', traditional: 16, bnx: 1, unit: 'hrs' },
  { phase: 'Source/Sink Connectors (S3/JDBC/Kafka)', traditional: 32, bnx: 3, unit: 'hrs' },
  { phase: 'Grafo de Grafos (PLAN + multi-MP)', traditional: 48, bnx: 3, unit: 'hrs' },
  { phase: 'Planes Cíclicos (CYCLIC + convergence)', traditional: 36, bnx: 3, unit: 'hrs' },
  { phase: 'Refactorizador Spark 2→3 / Python 2→3 / Glue 2→4', traditional: 40, bnx: 3, unit: 'hrs' },
  { phase: 'Step Functions + Terraform Codegen', traditional: 32, bnx: 2, unit: 'hrs' },
  { phase: 'Airflow DAG Codegen', traditional: 24, bnx: 2, unit: 'hrs' },
  { phase: 'React UI + DAG Viewer interactivo', traditional: 48, bnx: 4, unit: 'hrs' },
  { phase: 'Designer Visual (drag & drop)', traditional: 60, bnx: 4, unit: 'hrs' },
  { phase: 'Executive + Banking Model + DAMA', traditional: 40, bnx: 3, unit: 'hrs' },
  { phase: 'Governance (8 dominios, 55+ políticas)', traditional: 36, bnx: 3, unit: 'hrs' },
  { phase: 'Architecture + Glosario de mecanismos', traditional: 32, bnx: 3, unit: 'hrs' },
  { phase: 'Metrics + Estimadores + Comparativa', traditional: 28, bnx: 3, unit: 'hrs' },
  { phase: 'API (FastAPI + Lambda)', traditional: 24, bnx: 2, unit: 'hrs' },
  { phase: 'Deploy (Amplify + Lambda + CI/CD)', traditional: 16, bnx: 2, unit: 'hrs' },
  { phase: 'E2E Test AWS Glue + IAM policies', traditional: 20, bnx: 2, unit: 'hrs' },
  { phase: 'OCR + ZIP packaging + Admin mode', traditional: 24, bnx: 2, unit: 'hrs' },
]
